...
- TypeScript 7's native programmatic or LSP surface may eventually let us add opt-in type inference without giving up the parallel structural default; neither route is assumed until it passes the gates in `docs/type-checker-integration.md`.
